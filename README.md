...
1. `scp smb-restart-2026.07.25.9-noarch.txz root@<unraid-ip>:/boot/config/plugins/smb-restart/`
2. SSH into Unraid and run:
   ```
   upgradepkg --install-new --reinstall /boot/config/plugins/smb-restart/smb-restart-2026.07.25.9-noarch.txz
   ```
...
```
removepkg smb-restart-2026.07.25.9-noarch
